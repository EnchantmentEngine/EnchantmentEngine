...
then
  if [[ "$APP_HOST" =~ "ir-engine-mt" ]]
  then
    API_REPO_NAME=$DESTINATION_REPO_NAME_STEM-api-mt/$DESTINATION_REPO_NAME_STEM-api
    CLIENT_REPO_NAME=$DESTINATION_REPO_NAME_STEM-client-mt/$DESTINATION_REPO_NAME_STEM-client
    INSTANCESERVER_REPO_NAME=$DESTINATION_REPO_NAME_STEM-instanceserver-mt/$DESTINATION_REPO_NAME_STEM-instanceserver
    TESTBOT_REPO_NAME=$DESTINATION_REPO_NAME_STEM-testbot-mt/$DESTINATION_REPO_NAME_STEM-testbot
    TASKSERVER_REPO_NAME=$DESTINATION_REPO_NAME_STEM-taskserver-mt/$DESTINATION_REPO_NAME_STEM-taskserver
  elif [[ "$APP_HOST" =~ "ir-engine-qat" ]]
  then
    API_REPO_NAME=$DESTINATION_REPO_NAME_STEM-api-qat/$DESTINATION_REPO_NAME_STEM-api
    CLIENT_REPO_NAME=$DESTINATION_REPO_NAME_STEM-client-qat/$DESTINATION_REPO_NAME_STEM-client
    INSTANCESERVER_REPO_NAME=$DESTINATION_REPO_NAME_STEM-instanceserver-qat/$DESTINATION_REPO_NAME_STEM-instanceserver
    TESTBOT_REPO_NAME=$DESTINATION_REPO_NAME_STEM-testbot-qat/$DESTINATION_REPO_NAME_STEM-testbot
    TASKSERVER_REPO_NAME=$DESTINATION_REPO_NAME_STEM-taskserver-qat/$DESTINATION_REPO_NAME_STEM-taskserver
  else
