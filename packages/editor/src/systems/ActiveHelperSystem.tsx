...
const ActiveHelperReactor: React.FC<ComponentHelperEntry> = (helper) => {
  ...
  useEffect(() => {
    ...
    let preExistingBoundingBoxes = false
    ...
    return () => {
      if (preExistingBoundingBoxes) return
      removeComponent(entity, BoundingBoxComponent)
    }
  }, [selected, hovered, effectiveHelper?.volume, visibility, editorHelperState.volumeVisibility])
