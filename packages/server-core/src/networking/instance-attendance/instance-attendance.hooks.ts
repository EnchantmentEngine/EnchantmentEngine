    ...
    create: [
      ...
      async (context: HookContext<InstanceAttendanceService>) => {
        ...
        for (const instanceAttendance of data) {
          ...
          // If this is a world instance (not a channel), track world visit
          if (!instanceAttendance.isChannel && instanceAttendance.sceneId) {
            try {
              ...
              console.error('Error tracking world visit metrics:', error)
            }
          }
        }
