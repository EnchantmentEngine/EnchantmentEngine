...
import { createEntity, defineQuery, getComponent, getMutableComponent, setComponent, UUIDComponent } from '@ir-engine/ecs'
import { GLTFComponent, ParticleSystemComponent, SourceComponent } from '@ir-engine/engine'
import { EntityTreeComponent, NameComponent, TransformComponent, VisibleComponent } from '@ir-engine/spatial'
import {
  Euler,
  MathUtils,
  NormalBlending,
