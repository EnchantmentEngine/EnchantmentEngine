...
export const CameraSettingsComponent = defineComponent({
  ...
  schema: S.Object({
    ...
    projectionType: S.Const(ProjectionType, { default: ProjectionType.Perspective }),
    minCameraDistance: S.Number({ default: 1.5 }),
    maxCameraDistance: S.Number({ default: 50 }),
    startCameraDistance: S.Number({ default: 3 }),
    cameraMode: S.Const(FollowCameraMode, { default: FollowCameraMode.Dynamic }),
    cameraModeDefault: S.Const(FollowCameraMode, { default: FollowCameraMode.ThirdPerson }),
