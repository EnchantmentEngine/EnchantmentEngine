...
describe('EnvMapEquirectangularReactor', () => {}) //:: EnvMapEquirectangularReactor
describe('EnvMapBakeReactor', () => {}) //:: EnvMapBakeReactor
describe('EnvMapColorReactor', () => {}) //:: EnvMapColorReactor
describe('EnvMapReactor', () => {}) //:: EnvMapReactor
