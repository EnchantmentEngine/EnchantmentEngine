...
describe('glTF.scene Property (Root Level)', () => {
  ...
  it.todo('MUST have a value in range [0 .. glTF.scenes.length-1]', () => {})
  it.todo('MUST NOT be defined if `scenes` is undefined', () => {})
}) //:: glTF.scene (Root Level)

describe('glTF.scenes Property', () => {
  // @note Functionally required if glTF.scene is set
  it.todo('MAY be undefined', () => {})
  it.todo('MUST be an array of `scene` objects when defined', () => {})
