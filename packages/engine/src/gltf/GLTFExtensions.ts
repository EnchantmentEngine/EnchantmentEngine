...
// Note: KHR_animation_pointer is handled directly in the animation loading logic
// rather than as a traditional extension since it modifies animation channel behavior
