...
export class NodeDRACOLoader {
  ...
  addAttributeToGeometry(
    ...
    geometry.setAttribute(attributeName, new TypedBufferAttribute(geometryBuffer[attributeName], numComponents))
  ...
  convertDracoGeometryTo3JS(dracoDecoder, decoder, geometryType, buffer, attributeUniqueIdMap, attributeTypeMap) {
    ...
    if (geometryType == dracoDecoder.TRIANGULAR_MESH) {
      geometry.setIndex(
        new (geometryBuffer.indices.length > 65535 ? Uint32BufferAttribute : Uint16BufferAttribute)(
