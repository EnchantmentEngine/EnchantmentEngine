...
import { AnimationClip, BufferAttribute, BufferGeometry, Camera, Material, Mesh, Object3D, Scene, Texture } from 'three'
...
export interface GLTFWriter {
  ...
  processAccessor(attribute: BufferAttribute, geometry?: BufferGeometry, start?: number, count?: number): number | null
