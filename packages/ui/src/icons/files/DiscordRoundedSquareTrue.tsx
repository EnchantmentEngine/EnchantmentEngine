...
const DiscordRoundedSquareTrue = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
...
const ForwardRef = forwardRef(DiscordRoundedSquareTrue)
